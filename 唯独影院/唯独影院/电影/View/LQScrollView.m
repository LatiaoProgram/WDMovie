...
//    titleArr = @[@"美国队长1",@"美国队长2",@"美国队长3",@"美国队长4",@"美国队长5"];
    ...
    float offSetH = 60.0;
        ...
        //设置五个位置的rect
    float midWidth = WIDTH/2.0;
    float midheigh = HEIGHT*0.55-100-100;
    ...
    float midL2Width = WIDTH/3-offSetW-50;
    ...
    float midR2Width = WIDTH/3-offSetW-50;
...
//    imgV5.alpha = 0.5;
    ...
    imgV1.layer.zPosition = zPoint2;
    imgV2.layer.zPosition = zPoint1;
    imgV3.layer.zPosition = zPoint0;
    imgV4.layer.zPosition = zPoint1;
    imgV5.layer.zPosition = zPoint2;
...
#pragma mark --- 动画的处理
- (void)setImageOfzPpsition:(BOOL)isLOrR Z1:(float)z1 Z2:(float)z2 Z3:(float)z3 Z4:(float)z4 Z5:(float)z5 IMG1:(UIImageView *)img1 IMG2:(UIImageView *)img2 R1:(CGRect)R1 R2:(CGRect)R2 R3:(CGRect)R3 R4:(CGRect)R4 R5:(CGRect)R5 {
...
//                alphaArray  = @[@"0.5",@"0.9",@"1",@"0.9",@"0.5"];
                [self setImageOfzPpsition:isLOrR Z1:zPoint2 Z2:zPoint1 Z3:zPoint0 Z4:zPoint1 Z5:zPoint2 IMG1:imgV5 IMG2:imgV1 R1:rectmidL2 R2:rectmidL1 R3:rectmid R4:rectmidR1 R5:rectmidR2 ];
//                self.scoreLab.attributedText = [self scoreLable:3];
...
//                alphaArray  = @[@"0.9",@"1",@"0.9",@"0.5",@"0.5"];
                [self setImageOfzPpsition:isLOrR Z1:zPoint1 Z2:zPoint0 Z3:zPoint1 Z4:zPoint2 Z5:zPoint2 IMG1:imgV5 IMG2:imgV4 R1:rectmidL1 R2:rectmid R3:rectmidR1 R4:rectmidR2 R5:(rectmidL2) ];
...
//                alphaArray  = @[@"1",@"0.9",@"0.5",@"0.5",@"0.9"];
                [self setImageOfzPpsition:isLOrR Z1:zPoint0 Z2:zPoint1 Z3:zPoint2 Z4:zPoint2 Z5:zPoint1 IMG1:imgV4 IMG2:imgV3 R1:rectmid R2:rectmidR1 R3:rectmidR2 R4:rectmidL2 R5:rectmidL1 ];
...
//                alphaArray  = @[@"0.9",@"0.5",@"0.5",@"0.9",@"1"];
                ...
                [self setImageOfzPpsition:isLOrR Z1:zPoint1 Z2:zPoint2 Z3:zPoint2 Z4:zPoint1 Z5:zPoint0 IMG1:imgV3 IMG2:imgV2 R1:rectmidR1 R2:rectmidR2 R3:rectmidL2 R4:rectmidL1 R5:rectmid ];
...
//                alphaArray  = @[@"0.5",@"0.5",@"0.9",@"1",@"0.9"];
                ...
                [self setImageOfzPpsition:isLOrR Z1:zPoint2 Z2:zPoint2 Z3:zPoint1 Z4:zPoint0 Z5:zPoint1 IMG1:imgV2 IMG2:imgV1 R1:rectmidR2 R2:rectmidL2 R3:rectmidL1 R4:rectmid R5:rectmidR1 ];
...
//                alphaArray  = @[@"0.5",@"0.9",@"1",@"0.9",@"0.5"];
                ...
                [self setImageOfzPpsition:isLOrR Z1:zPoint2 Z2:zPoint1 Z3:zPoint0 Z4:zPoint1 Z5:zPoint2 IMG1:imgV1 IMG2:imgV5 R1:rectmidL2 R2:rectmidL1 R3:rectmid R4:rectmidR1 R5:rectmidR2 ];
